...
export class PanelFormGroup extends FormGroup {
  ...
  get ms(): FormControl<number> {
    return this.controls['ms'] as FormControl;
  }

  get size(): FormControl<number> {
    return this.controls['size'] as FormControl;
  }

  get additionalIDs(): FormControl<string | null> {
    return this.controls['additionalIDs'] as FormControl;
  }
